      ...
      try {
        ...
        try {
          ...
          if (companySnap.exists() && companySnap.data().name) {
            ...
            // Note: This may fail for guests due to 'list' permission restrictions.
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-[2.5rem] p-8 max-w-md w-full border border-gray-100 shadow-2xl text-center space-y-8 relative overflow-hidden">
          ...
          <p className="text-gray-600 text-sm font-medium leading-relaxed">
            Thank you for sharing your details. They have been securely sent directly to <span className="font-black text-gray-900">{companyName}</span>. Your system login credentials will be generated and emailed to you shortly.
          </p>
      ...
      <div className="bg-white rounded-[2.5rem] p-8 max-w-md w-full border border-gray-100 shadow-2xl space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs font-bold text-gray-500 leading-relaxed">
            You have been invited to join <span className="font-black text-violet-600">{companyName}</span> as an operational assistant.
          </p>
        </div>
