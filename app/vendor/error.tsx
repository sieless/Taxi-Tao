  ...
  return (
    <ErrorBoundary>
      <div className="min-h-[40vh] flex flex-col items-center justify-center p-8 text-center">
        <h2 className="text-lg font-bold text-gray-900 mb-2">Vendor Portal Error</h2>
        <p className="text-sm text-gray-500 mb-4">Something went wrong in the vendor portal.</p>
        <button
          onClick={() => reset()}
