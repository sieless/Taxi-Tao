...
export default function Footer() {
  ...
  if (pathname?.startsWith("/admin") || pathname?.startsWith("/driver") || pathname?.startsWith("/vendor")) {
    return null;
  }
    ...
    <footer className="w-full bg-neutral-950 text-neutral-300 px-4 py-10">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-neutral-400">
            ...
            <li><Link href="/signup?role=car_hire" className="hover:text-white transition">Register Fleet (Vendor)</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-neutral-400">
            ...
            <li><Link href="/car-hire-privacy" className="hover:text-white transition">Car Hire Privacy</Link></li>
            <li><Link href="/car-hire-terms" className="hover:text-white transition">Car Hire Terms</Link></li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-neutral-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-neutral-500">
        ...
        <div className="flex items-center gap-4">
          <a href="https://www.facebook.com/taxitao" target="_blank" rel="noopener noreferrer" className="hover:text-white transition" aria-label="Facebook">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
          </a>
          <a href="https://www.instagram.com/taxitao" target="_blank" rel="noopener noreferrer" className="hover:text-white transition" aria-label="Instagram">
          ...
          <a href="https://wa.me/254700000000" target="_blank" rel="noopener noreferrer" className="hover:text-white transition" aria-label="WhatsApp">
